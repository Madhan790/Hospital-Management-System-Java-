    ...
    public boolean getPatientById(int id){
        ...
        public void cancelAppointment() {
            ...
            try {
                ...
                String checkQuery = "SELECT * FROM appointments WHERE id = ? AND patient_id = ?";
                ...
                if (checkResultSet.next()) {
                    // Appointment belongs to the patient, proceed to cancel
                    String cancelQuery = "DELETE FROM appointments WHERE id = ?";
                    ...
                    System.out.println("Either the appointment does not exist or does not belong to the patient.");
                }
